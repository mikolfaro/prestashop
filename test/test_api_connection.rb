  ...
  module Api
    describe Connection do
      ...
      describe "invalid connection" do 
        it "should not be created" do 
          stub_request(:get, 'http://@localhost.com/api/').
              with(basic_auth: ['123', '']).
              to_return(status: [401, "Welcome to PrestaShop Webservice, please enter the authentication key as the login. No password required."])
      ...
      describe "valid connection" do 
        ...
        before              { stub_request(:get, 'http://localhost.com/api/').with(basic_auth: ['123', '']) }
        ...
        describe 'with xml expecting' do 
          ...
          it "should get" do
            stub_request(:get, 'http://localhost.com/api/products').
                with(basic_auth: ['123', '']).
          ...
          it "should get with id" do
            stub_request(:get, 'http://localhost.com/api/products/1').
                with(basic_auth: ['123', '']).
                to_return(body: response)
          ...
          it "should get with multiple ids" do
            stub_request(:get, 'http://localhost.com/api/products?id=[1,2,3]').
                with(basic_auth: ['123', '']).
                to_return(body: response)
          ...
          it "should post" do
            stub_request(:post, 'http://localhost.com/api/products').
                with(basic_auth: ['123', '']).
                to_return(body: response)
          ...
          it "should put" do
            stub_request(:put, 'http://localhost.com/api/products/1').
                with(basic_auth: ['123', '']).
                to_return(body: response)
          ...
          it "should upload" do
            ...
            stub_request(:post, 'http://localhost.com/api/images/products/1').
                with(basic_auth: ['123', '']).
                to_return(body: response)
